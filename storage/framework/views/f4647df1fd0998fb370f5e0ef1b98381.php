			...
			<div class="row">
				...
				<div class="col-sm-6 col-lg-3 p-b-50">
					...
					<p class="stext-107 cl7 size-201">
						Bạn có câu hỏi? Hãy liên hệ ngay với chúng tôi! Tại Nhà A4, Trường Đại học hàng hải Việt Nam a.k.a 484, Lạch Tray, Ngô Quyền, Hải Phòng.
						 Hoặc Email toan89471@st.vimaru.edu.vn.
					</p>
...
Copyright &copy; <script>document.write(new Date().getFullYear());</script> All rights reserved | Made with <i class="fa fa-heart-o" aria-hidden="true"></i> by Nhóm mấy quên rồi.
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
...
<?php /**PATH D:\Programs\XAMPP\htdocs\dingmp3\resources\views/footer.blade.php ENDPATH**/ ?>