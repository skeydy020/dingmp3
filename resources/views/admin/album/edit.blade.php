    ...
    <form action="" method="POST">
        <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="singer_id">
                            @foreach($singers as $singer)
                                <option value="{{ $singer->id }}" {{ $album->singer_id == $singer->id ? 'selected' : '' }}>
                                    {{ $singer->name }}
                                </option>
                            @endforeach
                        </select>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" name="likes" value="{{ $album->likes }}"  class="form-control" >
                    </div>
                </div>
            ...
            <div class="form-group">
                ...
                <div id="image_show">
                    <a href="{{ $album->thumb }}" target="_blank">
                        <img src="{{ $album->thumb }}" width="100px">
                    </a>
                </div>
                <input type="hidden" name="thumb" value="{{ $album->thumb }}" id="thumb">
            </div>
            ...
            <div class="form-group">
                ...
                <div class="custom-control custom-radio">
                    <input class="custom-control-input" value="1" type="radio" id="active" name="active"
                        {{ $album->active == 1 ? ' checked=""' : '' }}>
                    <label for="active" class="custom-control-label">Có</label>
                </div>
                <div class="custom-control custom-radio">
                    <input class="custom-control-input" value="0" type="radio" id="no_active" name="active"
                        {{ $album->active == 0 ? ' checked=""' : '' }}>
